...
- The resulting patch names are stored on the E1 and are loaded instantly whenever the E1 loads. If you change patches on the Peak or move the preset to a different slot then repeat the process.
